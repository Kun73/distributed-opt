...
\begin{equation}
\tilde{U}(k'-K) \leq\left(1-\frac{3 \theta}{2 k'}\right) \tilde{U}(k'-K)+\frac{3 \theta L^{2}}{n \mu^{2}} \frac{\tilde{V}(k'-K)}{k'}+\frac{\theta^{2} \sigma^{2}}{n \mu^{2}} \frac{1}{k'^{2}}, \quad \forall k' \geq K_{1}
\end{equation}
...
By induction and lemma \@ref(lem:prodineq), we bound $U(k)$ with the network dependent term decaying faster, i.e. 
