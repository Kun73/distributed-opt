...
```{lemma, eigvrc}
Under assumptions \@ref(exr:mrc) and \@ref(exr:adigrap), the matrix $R$ has a unique nonnegative left eigenvector $u^T$(w.r.t. eigenvalue 1) with $u^T\boldsymbol1 = n$, and the matrix $C$ has a unique nonnegative right eigenvector $v$ (w.r.t. eigenvalue 1) with $\boldsymbol1^T v = n$, i.e., 
$$
  u^T R = 1\cdot u^T
$$
